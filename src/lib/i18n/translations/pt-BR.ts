const ptBR = {
  ...
  advancesDescription: 'Sinais já recebidos de turnos agendados para o próximo mês, independente de quando foram pagos. O dinheiro já está na conta, mas o faturamento pertence ao mês seguinte.',
